...
function InsightCard({ insight }) {
  ...
  const Icon = cfg.icon;
  return (
    <div className={`${cfg.bg} ${cfg.border} border rounded-xl p-4 overflow-hidden`} data-testid={`insight-${insight.priority}`}>
    ...
    <div className="space-y-6" data-testid="creator-control-room">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div className="flex items-center gap-3">
          <div className="w-11 h-11 rounded-xl bg-[#0A192F] flex items-center justify-center flex-shrink-0">
