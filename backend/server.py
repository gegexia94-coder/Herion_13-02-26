...
# Shared modules
from database import db, client as mongo_client, logger
from auth import (
...
# ========================
# ADMIN STATISTICS (extracted to routes/admin_routes.py)
# ========================
...
# CORS Middleware
cors_origins_str = os.environ.get('CORS_ORIGINS', os.environ.get('FRONTEND_URL', '*'))
