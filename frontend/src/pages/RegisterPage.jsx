...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] flex" data-testid="register-page">
      <div className="hidden lg:flex lg:w-[42%] bg-[#0A192F] text-white p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-20">
            <div className="w-11 h-11 rounded-xl bg-[#3B82F6]/15 flex items-center justify-center">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M6 4V20" stroke="#3B82F6" strokeWidth="2.5" strokeLinecap="round"/><path d="M18 4V20" stroke="#3B82F6" strokeWidth="2.5" strokeLinecap="round"/><path d="M6 12H18" stroke="#3B82F6" strokeWidth="2.5" strokeLinecap="round"/></svg>
            </div>
        ...
        <div className="w-full max-w-xl animate-fade-in-up">
          <div className="lg:hidden flex items-center gap-2.5 mb-8">
            <div className="w-10 h-10 rounded-xl bg-[#0A192F] flex items-center justify-center">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M6 4V20" stroke="#3B82F6" strokeWidth="2.5" strokeLinecap="round"/><path d="M18 4V20" stroke="#3B82F6" strokeWidth="2.5" strokeLinecap="round"/><path d="M6 12H18" stroke="#3B82F6" strokeWidth="2.5" strokeLinecap="round"/></svg>
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-4">
              <p className="text-xs font-semibold text-[#0A192F] uppercase tracking-wider">Informazioni Personali</p>
            ...
            <div className="space-y-4 pt-2">
              <p className="text-xs font-semibold text-[#0A192F] uppercase tracking-wider">Residenza</p>
            ...
            {/* Client Type */}
            <div className="space-y-4 pt-2">
              <p className="text-xs font-semibold text-[#0A192F] uppercase tracking-wider">Tipo di Cliente</p>
              <div className="grid grid-cols-3 gap-2.5">
                {CLIENT_TYPES.map(t => (
                  <button key={t.value} type="button" onClick={() => set('client_type', t.value)}
                    className={`p-3.5 border rounded-xl text-center transition-all duration-200 ${form.client_type === t.value ? 'border-[#0A192F] bg-[#0A192F]/[0.03] ring-1 ring-[#0A192F]' : 'border-[#E2E8F0] hover:border-[#0A192F]/30'}`}
                    data-testid={`client-type-${t.value}`}>
                    <t.icon className={`w-5 h-5 mx-auto mb-1.5 ${form.client_type === t.value ? 'text-[#0A192F]' : 'text-[#94A3B8]'}`} strokeWidth={1.5} />
            ...
            {/* Fiscal Info */}
            <div className="space-y-4 pt-2">
              <p className="text-xs font-semibold text-[#0A192F] uppercase tracking-wider">Dati Fiscali</p>
              {showVat && (
            ...
            {/* Password */}
            <div className="space-y-4 pt-2">
              <p className="text-xs font-semibold text-[#0A192F] uppercase tracking-wider">Sicurezza</p>
              <div className="grid grid-cols-2 gap-3">
            ...
            <div className="space-y-3 pt-2">
              <div className="flex items-start space-x-3">
                ...
                <div><Label htmlFor="privacy" className="text-sm text-[#475569] cursor-pointer">Accetto l'<span className="text-[#0A192F] font-medium">informativa sulla privacy</span> *</Label><FieldError field="privacy_consent" /></div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div><Label htmlFor="terms" className="text-sm text-[#475569] cursor-pointer">Accetto i <span className="text-[#0A192F] font-medium">termini di servizio</span> *</Label><FieldError field="terms_consent" /></div>
              </div>
            </div>

            <Button type="submit" disabled={loading} className="w-full bg-[#0A192F] hover:bg-[#0B243B] text-white rounded-xl h-12 text-sm font-semibold shadow-sm" data-testid="register-submit-btn">
          ...
          <p className="mt-6 text-center text-sm text-[#475569]">
            Hai gia un account? <Link to="/login" className="text-[#0A192F] font-semibold hover:underline" data-testid="login-link">Accedi</Link>
          </p>
        </div>
      </div>
    </div>
