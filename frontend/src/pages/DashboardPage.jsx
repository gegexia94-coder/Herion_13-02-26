...
import { FileText, Plus, Clock, CheckCircle, AlertCircle, Bell, ArrowRight, TrendingUp, Sparkles, Globe, Shield, Zap } from 'lucide-react';
...
export default function DashboardPage() {
  ...
  const loadData = async () => {
    try {
      const [s, n] = await Promise.all([getDashboardStats(), getNotifications()]);
      setStats(s.data);
    ...
    <div className="space-y-8" data-testid="dashboard-page">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {[
          ...
          { icon: Shield, title: 'Conformita garantita', desc: 'I nostri agenti AI verificano ogni pratica rispetto alle normative europee.', color: 'text-[#0F4C5C]', bg: 'bg-[#0F4C5C]/5' },
      ...
      <div className="bg-[#0F4C5C] rounded-2xl p-6 text-white relative overflow-hidden">
        ...
        <div className="flex items-center gap-4 relative z-10">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-white/60">Analisi, validazione, conformita, documenti e comunicazione. Ogni decisione e trasparente, tracciabile e spiegabile.</p>
          </div>
