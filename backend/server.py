...
CATALOG_CATEGORIES = {
    "fiscale": {
        "id": "fiscale",
        "label": "Fiscale",
        "description": "Adempimenti fiscali: IVA, dichiarazioni, pagamenti",
        "icon": "receipt",
        "is_official": True,
    },
    "previdenziale": {
        "id": "previdenziale",
        "label": "Previdenziale",
        "description": "Contributi previdenziali e gestione INPS",
        "icon": "shield",
        "is_official": True,
    },
    "societario": {
        "id": "societario",
        "label": "Societario",
        "description": "Camera di Commercio, Registro Imprese, operazioni societarie",
        "icon": "building",
        "is_official": True,
    },
    "documentale": {
        "id": "documentale",
        "label": "Documentale",
        "description": "Preparazione, verifica e consegna documenti",
        "icon": "file-text",
        "is_official": False,
    },
    "informativo": {
        "id": "informativo",
        "label": "Informativo",
        "description": "Richieste informazioni, supporto, aggiornamenti",
        "icon": "info",
        "is_official": False,
    },
}
...
async def get_catalog_categories(user: dict = Depends(get_current_user)):
    """Return catalog categories with procedure counts."""
    categories = []
    for cat_id, cat in CATALOG_CATEGORIES.items():
        count = await db.practice_catalog.count_documents({"category": cat_id})
        categories.append({**cat, "procedure_count": count})
    return categories
...
""")
    ...
    # Creator bootstrap - protected identity (non-blocking)
    try:
        ...
        logger.error(f"Creator bootstrap failed (non-blocking): {e}")
    ...
    if catalog_count == 0:
        catalog_entries = [
            # ══════════════════════════════════════
            # CATEGORY: informativo (internal support)
            # ══════════════════════════════════════
            {
                "practice_id": "INFO_FISCAL_GENERIC",
                "name": "Richiesta informazioni fiscali generiche",
                "description": "Richiesta di chiarimenti su adempimenti fiscali di base.",
                "category": "informativo", "category_label": "Informativo",
                "procedure_type": "internal_support",
                "user_type": ["private", "freelancer", "company"], "country_scope": "IT",
                "operational_status": "active_italy_scope",
                "scope_note": "Supporto informativo attivo per utenti in Italia.",
                "risk_level": "basic", "support_level": "supported",
                "expected_channel": "email", "destination_type": "informational",
                "required_documents": [],
                "document_specs": [],
                "official_action": None,
                "who_acts": {"herion_prepares": True, "herion_submits": False, "user_submits": False, "user_signs": False, "delegation_possible": False, "entity_response_expected": False},
                "auth_method": None,
                "proof_expected": None,
                "estimated_duration": {"label": "1-2 giorni lavorativi", "min_days": 1, "max_days": 2},
                "delegation_required": False, "approval_required": False,
                "agents": ["intake", "research", "advisor"],
                "blocking_conditions": [], "escalation_conditions": ["ambiguita normativa"],
                "next_step": "Invio informazioni",
                "user_explanation": "Richiesta di informazioni fiscali di base. Herion raccoglie la domanda e fornisce indicazioni chiare.",
            },
            {
                "practice_id": "DOC_MISSING_REQUEST",
                "name": "Richiesta documenti mancanti",
                "description": "Notifica all'utente sui documenti necessari per procedere.",
                "category": "documentale", "category_label": "Documentale",
                "procedure_type": "internal_support",
                "user_type": ["private", "freelancer", "company"], "country_scope": "IT",
                "operational_status": "active_internal",
                "scope_note": "Servizio interno di piattaforma.",
                "risk_level": "basic", "support_level": "supported",
                "expected_channel": "email", "destination_type": "user_communication",
                "required_documents": [],
                "document_specs": [],
                "official_action": None,
                "who_acts": {"herion_prepares": True, "herion_submits": True, "user_submits": False, "user_signs": False, "delegation_possible": False, "entity_response_expected": False},
                "auth_method": None,
                "proof_expected": None,
                "estimated_duration": {"label": "Immediato", "min_days": 0, "max_days": 1},
                "delegation_required": False, "approval_required": False,
                "agents": ["documents", "flow", "advisor"],
                "blocking_conditions": [], "escalation_conditions": [],
                "next_step": "Attesa caricamento documenti",
                "user_explanation": "Ti indichiamo quali documenti servono per completare la tua pratica.",
            },
            {
                "practice_id": "DOC_PRELIMINARY_SEND",
                "name": "Invio documenti preliminari",
                "description": "Invio di documentazione preliminare a un destinatario.",
                "category": "documentale", "category_label": "Documentale",
                "procedure_type": "internal_support",
                "user_type": ["private", "freelancer", "company"], "country_scope": "IT",
                "operational_status": "active_italy_scope",
                "scope_note": "Invio documenti preparatori.",
                "risk_level": "basic", "support_level": "supported",
                "expected_channel": "email", "destination_type": "external_recipient",
                "required_documents": ["identity"],
                "document_specs": [{"key": "identity", "name": "Documento di identita", "why_needed": "Per verificare l'identita del mittente", "format": "PDF, JPG", "mandatory": True}],
                "official_action": None,
                "who_acts": {"herion_prepares": True, "herion_submits": False, "user_submits": False, "user_signs": False, "delegation_possible": False, "entity_response_expected": False},
                "auth_method": None,
                "proof_expected": {"type": "pec_delivery", "timing": "immediate", "label": "Conferma consegna", "optional": True},
                "estimated_duration": {"label": "1-3 giorni lavorativi", "min_days": 1, "max_days": 3},
                "delegation_required": False, "approval_required": True,
                "agents": ["documents", "routing", "advisor"],
                "blocking_conditions": ["documenti mancanti"], "escalation_conditions": [],
                "next_step": "Conferma ricezione",
                "user_explanation": "Preparazione e invio della documentazione preliminare.",
            },
            {
                "practice_id": "PRACTICE_FOLLOWUP",
                "name": "Promemoria e follow-up pratica",
                "description": "Promemoria sullo stato di avanzamento di una pratica.",
                "category": "informativo", "category_label": "Informativo",
                "procedure_type": "internal_support",
                "user_type": ["private", "freelancer", "company"], "country_scope": "IT",
                "operational_status": "active_internal",
                "scope_note": "Servizio interno di monitoraggio.",
                "risk_level": "basic", "support_level": "supported",
                "expected_channel": "email", "destination_type": "user_communication",
                "required_documents": [],
                "document_specs": [],
                ...
                "auth_method": None,
                "proof_expected": None,
                "estimated_duration": {"label": "Immediato", "min_days": 0, "max_days": 0},
                "delegation_required": False, "approval_required": False,
                "agents": ["monitor", "deadline", "advisor"],
                "blocking_conditions": [], "escalation_conditions": [],
                "next_step": "Verifica stato pratica",
                "user_explanation": "Ricevi aggiornamenti e promemoria sullo stato della tua pratica.",
            },
            {
                "practice_id": "BLOCKED_RECOVERY",
                "name": "Recupero pratica bloccata",
                "description": "Recupero di una pratica in stato bloccato.",
                "category": "documentale", "category_label": "Documentale",
                "procedure_type": "internal_support",
                "user_type": ["private", "freelancer", "company"], "country_scope": "IT",
                "operational_status": "active_internal",
                "scope_note": "Recupero pratica bloccata.",
                "risk_level": "basic", "support_level": "supported",
                "expected_channel": "preparation_only", "destination_type": "internal",
                "required_documents": [],
                "document_specs": [],
                "official_action": None,
                "who_acts": {"herion_prepares": True, "herion_submits": False, "user_submits": False, "user_signs": False, "delegation_possible": False, "entity_response_expected": False},
                ...
                "estimated_duration": {"label": "1-3 giorni lavorativi", "min_days": 1, "max_days": 3},
                "delegation_required": False, "approval_required": False,
                "agents": ["flow", "monitor", "documents"],
                "blocking_conditions": [], "escalation_conditions": ["blocco persistente"],
                "next_step": "Identificazione causa blocco",
                "user_explanation": "Identifichiamo cosa blocca la pratica e ti guidiamo nella risoluzione.",
            },
            {
                "practice_id": "DOSSIER_DELIVERY",
                "name": "Consegna dossier finale",
                "description": "Consegna del fascicolo completo della pratica.",
                "category": "documentale", "category_label": "Documentale",
                "procedure_type": "internal_support",
                "user_type": ["private", "freelancer", "company"], "country_scope": "IT",
                "operational_status": "active_italy_scope",
                "scope_note": "Consegna fascicolo.",
                "risk_level": "basic", "support_level": "supported",
                "expected_channel": "email", "destination_type": "user_delivery",
                "required_documents": ["practice_documents"],
                "document_specs": [{"key": "practice_documents", "name": "Documenti della pratica", "why_needed": "Documenti generati e raccolti durante la pratica", "format": "PDF", "mandatory": True}],
                "official_action": None,
                "who_acts": {"herion_prepares": True, "herion_submits": True, "user_submits": False, "user_signs": False, "delegation_possible": False, "entity_response_expected": False},
                "auth_method": None,
                "proof_expected": None,
                "estimated_duration": {"label": "1 giorno lavorativo", "min_days": 0, "max_days": 1},
                "delegation_required": False, "approval_required": True,
                "agents": ["documents", "advisor"],
                "blocking_conditions": ["documenti incompleti"], "escalation_conditions": [],
                "next_step": "Download o invio dossier",
                "user_explanation": "Il fascicolo completo della pratica viene preparato e consegnato.",
            },
            {
                "practice_id": "STATUS_UPDATE",
                "name": "Aggiornamento stato pratica",
                "description": "Comunicazione di aggiornamento sullo stato della pratica.",
                "category": "informativo", "category_label": "Informativo",
                "procedure_type": "internal_support",
                "user_type": ["private", "freelancer", "company"], "country_scope": "IT",
                "operational_status": "active_internal",
                "scope_note": "Aggiornamento interno.",
                "risk_level": "basic", "support_level": "supported",
                "expected_channel": "email", "destination_type": "user_communication",
                "required_documents": [],
                "document_specs": [],
                ...
                "estimated_duration": {"label": "Immediato", "min_days": 0, "max_days": 0},
                "delegation_required": False, "approval_required": False,
                "agents": ["monitor", "advisor"],
                "blocking_conditions": [], "escalation_conditions": [],
                "next_step": "Prossima azione",
                "user_explanation": "Ricevi un riepilogo aggiornato sullo stato della tua pratica.",
            },
            {
                "practice_id": "DOC_COMPLETENESS",
                "name": "Verifica completezza documenti",
                "description": "Controllo che tutti i documenti necessari siano presenti.",
                "category": "documentale", "category_label": "Documentale",
                "procedure_type": "internal_support",
                "user_type": ["private", "freelancer", "company"], "country_scope": "IT",
                "operational_status": "active_internal",
                "scope_note": "Verifica interna.",
                "risk_level": "basic", "support_level": "supported",
                "expected_channel": "preparation_only", "destination_type": "internal",
                "required_documents": [],
                "document_specs": [],
                ...
                "estimated_duration": {"label": "Immediato", "min_days": 0, "max_days": 0},
                "delegation_required": False, "approval_required": False,
                "agents": ["documents", "flow"],
                "blocking_conditions": [], "escalation_conditions": [],
                "next_step": "Risultato verifica",
                "user_explanation": "Verifichiamo che tutti i documenti necessari siano stati caricati.",
            },
            {
                "practice_id": "USER_APPROVAL_REQ",
                "name": "Richiesta approvazione utente",
                "description": "Richiesta di approvazione esplicita prima di procedere.",
                "category": "documentale", "category_label": "Documentale",
                "procedure_type": "internal_support",
                "user_type": ["private", "freelancer", "company"], "country_scope": "IT",
                "operational_status": "active_internal",
                "scope_note": "Flusso di approvazione interno.",
                "risk_level": "basic", "support_level": "supported",
                "expected_channel": "email", "destination_type": "user_communication",
                "required_documents": [],
                "document_specs": [],
                ...
                "auth_method": None,
                "proof_expected": None,
                "estimated_duration": {"label": "Dipende dall'utente", "min_days": 0, "max_days": 5},
                "delegation_required": False, "approval_required": True,
                "agents": ["flow", "monitor"],
                "blocking_conditions": [], "escalation_conditions": [],
                "next_step": "Attesa approvazione",
                "user_explanation": "Prima di procedere, ti chiediamo di verificare e approvare il riepilogo.",
            },
            {
                "practice_id": "PDF_REPORT_DELIVERY",
                "name": "Consegna PDF/report finale",
                "description": "Generazione e consegna del report PDF finale.",
                "category": "documentale", "category_label": "Documentale",
                "procedure_type": "internal_support",
                "user_type": ["private", "freelancer", "company"], "country_scope": "IT",
                "operational_status": "active_internal",
                "scope_note": "Generazione report.",
                "risk_level": "basic", "support_level": "supported",
                "expected_channel": "email", "destination_type": "user_delivery",
                "required_documents": [],
                "document_specs": [],
                ...
                "agents": ["documents", "advisor"],
                "blocking_conditions": [], "escalation_conditions": [],
                "next_step": "Download report",
                "user_explanation": "Il report finale della pratica viene generato e messo a disposizione.",
            },
            # ══════════════════════════════════════
            # CATEGORY: fiscale (real official procedures)
            # ══════════════════════════════════════
            {
                "practice_id": "VAT_OPEN_PF",
                "name": "Apertura Partita IVA persone fisiche",
                "description": "Preparazione della pratica di apertura partita IVA per individui e freelance.",
                "category": "fiscale", "category_label": "Fiscale",
                "procedure_type": "official_procedure",
                "user_type": ["freelancer"], "country_scope": "IT",
                "operational_status": "active_italy_scope",
                "scope_note": "Riferimento: Agenzia delle Entrate, modello AA9/12.",
                "risk_level": "medium", "support_level": "supported",
                "expected_channel": "official_portal", "destination_type": "tax_authority",
                "required_documents": ["identity", "tax_declarations"],
                "document_specs": [
                    {"key": "identity", "name": "Documento di identita", "why_needed": "Obbligatorio per identificazione presso l'Agenzia delle Entrate", "format": "PDF o immagine (fronte/retro)", "mandatory": True},
                    {"key": "tax_declarations", "name": "Codice fiscale / tessera sanitaria", "why_needed": "Necessario per associare la P.IVA al codice fiscale", "format": "PDF o immagine", "mandatory": True},
                ],
                "official_action": {
                    "code": "apertura_partita_iva_pf",
                    "label": "Apertura Partita IVA",
                    "description": "Invio del modello AA9/12 all'Agenzia delle Entrate per l'apertura della Partita IVA",
                    "entity_name": "Agenzia delle Entrate",
                    "form_reference": "Modello AA9/12",
                },
                "who_acts": {"herion_prepares": True, "herion_submits": False, "user_submits": True, "user_signs": False, "delegation_possible": False, "entity_response_expected": True},
                "auth_method": "SPID",
                "proof_expected": {"type": "protocol_number", "timing": "immediate", "label": "Numero di protocollo rilasciato dal portale", "optional": False},
                "estimated_duration": {"label": "3-5 giorni lavorativi", "min_days": 3, "max_days": 5},
                "delegation_required": False, "approval_required": True,
                "agents": ["intake", "research", "routing", "documents", "flow"],
                "blocking_conditions": ["documenti identita mancanti", "codice fiscale mancante"],
                "escalation_conditions": ["struttura societaria complessa"],
                "next_step": "Preparazione modello AA9/12",
                "user_explanation": "Ti guidiamo nella preparazione della pratica di apertura Partita IVA presso l'Agenzia delle Entrate. Herion prepara il modello, tu lo invii sul portale con le tue credenziali SPID.",
            },
            {
                "practice_id": "VAT_VARIATION_PF",
                "name": "Variazione Partita IVA persone fisiche",
                "description": "Modifica dei dati della partita IVA per persone fisiche.",
                "category": "fiscale", "category_label": "Fiscale",
                "procedure_type": "official_procedure",
                "user_type": ["freelancer"], "country_scope": "IT",
                "operational_status": "active_italy_scope",
                "scope_note": "Variazione dati P.IVA tramite modello AA9/12.",
                "risk_level": "medium", "support_level": "supported",
                "expected_channel": "official_portal", "destination_type": "tax_authority",
                "required_documents": ["identity"],
                "document_specs": [
                    {"key": "identity", "name": "Documento di identita", "why_needed": "Per confermare l'identita del titolare P.IVA", "format": "PDF o immagine", "mandatory": True},
                ],
                "official_action": {
                    "code": "variazione_partita_iva_pf",
                    "label": "Variazione dati Partita IVA",
                    "description": "Invio variazione tramite modello AA9/12 all'Agenzia delle Entrate",
                    "entity_name": "Agenzia delle Entrate",
                    "form_reference": "Modello AA9/12",
                },
                "who_acts": {"herion_prepares": True, "herion_submits": False, "user_submits": True, "user_signs": False, "delegation_possible": False, "entity_response_expected": True},
                "auth_method": "SPID",
                "proof_expected": {"type": "protocol_number", "timing": "immediate", "label": "Numero di protocollo della variazione", "optional": False},
                "estimated_duration": {"label": "2-4 giorni lavorativi", "min_days": 2, "max_days": 4},
                "delegation_required": False, "approval_required": True,
                "agents": ["research", "routing", "documents", "flow"],
                "blocking_conditions": ["partita IVA non attiva"],
                "escalation_conditions": ["variazione complessa"],
                "next_step": "Preparazione variazione",
                "user_explanation": "Preparazione della variazione dei dati della tua Partita IVA. Herion prepara il modello, tu lo invii.",
            },
            {
                "practice_id": "VAT_CLOSURE_PF",
                "name": "Chiusura Partita IVA persone fisiche",
                "description": "Preparazione della chiusura della partita IVA.",
                "category": "fiscale", "category_label": "Fiscale",
                "procedure_type": "official_procedure",
                "user_type": ["freelancer"], "country_scope": "IT",
                "operational_status": "active_italy_scope",
                "scope_note": "Chiusura P.IVA tramite modello AA9/12.",
                "risk_level": "medium", "support_level": "supported",
                "expected_channel": "official_portal", "destination_type": "tax_authority",
                "required_documents": ["identity", "tax_declarations"],
                "document_specs": [
                    {"key": "identity", "name": "Documento di identita", "why_needed": "Per confermare l'identita del titolare", "format": "PDF o immagine", "mandatory": True},
                    {"key": "tax_declarations", "name": "Ultima dichiarazione dei redditi", "why_needed": "Per verificare l'assenza di pendenze fiscali", "format": "PDF", "mandatory": True},
                ],
                "official_action": {
                    "code": "chiusura_partita_iva_pf",
                    "label": "Chiusura Partita IVA",
                    "description": "Invio della cessazione tramite modello AA9/12 all'Agenzia delle Entrate",
                    "entity_name": "Agenzia delle Entrate",
                    "form_reference": "Modello AA9/12",
                },
                "who_acts": {"herion_prepares": True, "herion_submits": False, "user_submits": True, "user_signs": False, "delegation_possible": True, "entity_response_expected": True},
                "auth_method": "SPID",
                "proof_expected": {"type": "protocol_number", "timing": "immediate", "label": "Numero di protocollo della cessazione", "optional": False},
                "estimated_duration": {"label": "5-10 giorni lavorativi", "min_days": 5, "max_days": 10},
                "delegation_required": False, "approval_required": True,
                "agents": ["research", "routing", "documents", "flow", "delegate"],
                "blocking_conditions": ["debiti pendenti non verificati"],
                "escalation_conditions": ["pendenze fiscali complesse"],
                "next_step": "Verifica pendenze e preparazione chiusura",
                "user_explanation": "Ti guidiamo nella chiusura della Partita IVA, verificando pendenze e requisiti. Herion prepara tutto, tu invii sul portale.",
            },
            {
                "practice_id": "F24_PREPARATION",
                "name": "Preparazione e validazione F24",
                "description": "Supporto nella compilazione e verifica del modello F24.",
                "category": "fiscale", "category_label": "Fiscale",
                "procedure_type": "official_procedure",
                "user_type": ["private", "freelancer", "company"], "country_scope": "IT",
                "operational_status": "active_italy_scope",
                "scope_note": "Modello F24 — strumento di pagamento fiscale nazionale.",
                "risk_level": "medium", "support_level": "supported",
                "expected_channel": "preparation_only", "destination_type": "tax_payment",
                "required_documents": ["accounting"],
                "document_specs": [
                    {"key": "accounting", "name": "Dati contabili / importi da versare", "why_needed": "Per calcolare correttamente i codici tributo e gli importi", "format": "PDF o foglio di calcolo", "mandatory": True},
                ],
                "official_action": {
                    "code": "compilazione_f24",
                    "label": "Compilazione modello F24",
                    "description": "Preparazione del modello F24 per il pagamento di imposte, contributi e tributi",
                    "entity_name": "Agenzia delle Entrate",
                    "form_reference": "Modello F24",
                },
                "who_acts": {"herion_prepares": True, "herion_submits": False, "user_submits": True, "user_signs": False, "delegation_possible": False, "entity_response_expected": False},
                "auth_method": None,
                "proof_expected": {"type": "payment_receipt", "timing": "immediate", "label": "Quietanza di pagamento F24", "optional": False},
                "estimated_duration": {"label": "1-2 giorni lavorativi", "min_days": 1, "max_days": 2},
                "delegation_required": False, "approval_required": True,
                "agents": ["ledger", "documents", "compliance", "advisor"],
                "blocking_conditions": ["dati contabili insufficienti"],
                "escalation_conditions": ["importi significativi non verificati"],
                "next_step": "Compilazione F24",
                "user_explanation": "Prepariamo e verifichiamo il modello F24 per i tuoi pagamenti fiscali.",
            },
            {
                "practice_id": "F24_WEB",
                "name": "Supporto F24 Web",
                "description": "Supporto per la compilazione F24 tramite portale web.",
                "category": "fiscale", "category_label": "Fiscale",
                "procedure_type": "official_procedure",
                "user_type": ["private", "freelancer", "company"], "country_scope": "IT",
                "operational_status": "active_italy_scope",
                "scope_note": "Portale F24 Web dell'Agenzia delle Entrate.",
                "risk_level": "medium", "support_level": "supported",
                "expected_channel": "official_portal", "destination_type": "tax_payment",
                "required_documents": ["accounting"],
                "document_specs": [
                    {"key": "accounting", "name": "Dati contabili / importi", "why_needed": "Per compilare correttamente il modello F24 online", "format": "PDF o dati strutturati", "mandatory": True},
                ],
                "official_action": {
                    "code": "invio_f24_web",
                    "label": "Invio F24 tramite portale web",
                    "description": "Compilazione e invio del modello F24 tramite il servizio F24 Web dell'Agenzia delle Entrate",
                    "entity_name": "Agenzia delle Entrate",
                    "form_reference": "F24 Web",
                },
                "who_acts": {"herion_prepares": True, "herion_submits": False, "user_submits": True, "user_signs": False, "delegation_possible": False, "entity_response_expected": True},
                "auth_method": "SPID",
                "proof_expected": {"type": "portal_confirmation", "timing": "immediate", "label": "Conferma invio dal portale F24 Web", "optional": False},
                "estimated_duration": {"label": "1-2 giorni lavorativi", "min_days": 1, "max_days": 2},
                "delegation_required": False, "approval_required": True,
                "agents": ["routing", "research", "ledger", "flow"],
                "blocking_conditions": ["accesso portale non verificato"],
                "escalation_conditions": [],
                "next_step": "Accesso e compilazione F24 Web",
                "user_explanation": "Ti guidiamo nell'uso del portale F24 Web. Herion prepara i dati, tu compili e invii sul portale.",
            },
            {
                "practice_id": "VAT_DECLARATION",
                "name": "Supporto dichiarazione IVA",
                "description": "Preparazione della dichiarazione IVA periodica.",
                "category": "fiscale", "category_label": "Fiscale",
                "procedure_type": "official_procedure",
                "user_type": ["freelancer", "company"], "country_scope": "IT",
                "operational_status": "active_italy_scope",
                "scope_note": "Dichiarazione IVA. Portale Agenzia delle Entrate.",
                "risk_level": "medium", "support_level": "supported",
                "expected_channel": "official_portal", "destination_type": "tax_authority",
                "required_documents": ["vat_documents", "invoices", "accounting"],
                "document_specs": [
                    {"key": "vat_documents", "name": "Registri IVA", "why_needed": "Base per il calcolo dell'IVA a debito/credito", "format": "PDF o export contabile", "mandatory": True},
                    {"key": "invoices", "name": "Fatture emesse e ricevute", "why_needed": "Per la riconciliazione con i registri IVA", "format": "PDF o XML", "mandatory": True},
                    {"key": "accounting", "name": "Prospetto contabile", "why_needed": "Per verificare la correttezza degli importi", "format": "PDF o foglio di calcolo", "mandatory": True},
                ],
                "official_action": {
                    "code": "invio_dichiarazione_iva",
                    "label": "Invio dichiarazione IVA",
                    "description": "Invio della dichiarazione IVA periodica o annuale tramite il portale dell'Agenzia delle Entrate",
                    "entity_name": "Agenzia delle Entrate",
                    "form_reference": "Dichiarazione IVA annuale / LIPE trimestrale",
                },
                "who_acts": {"herion_prepares": True, "herion_submits": False, "user_submits": True, "user_signs": True, "delegation_possible": True, "entity_response_expected": True},
                "auth_method": "SPID",
                "proof_expected": {"type": "protocol_number", "timing": "delayed", "label": "Ricevuta telematica dell'Agenzia delle Entrate", "optional": False},
                "estimated_duration": {"label": "5-10 giorni lavorativi", "min_days": 5, "max_days": 10},
                "delegation_required": False, "approval_required": True,
                "agents": ["research", "documents", "compliance", "flow"],
                "blocking_conditions": ["registri IVA incompleti"],
                "escalation_conditions": ["operazioni intracomunitarie complesse"],
                "next_step": "Preparazione dichiarazione",
                "user_explanation": "Prepariamo la tua dichiarazione IVA verificando registri e documenti. Tu la firmi e la invii.",
            },
            {
                "practice_id": "EINVOICING",
                "name": "Supporto fatturazione elettronica",
                "description": "Supporto per l'emissione e gestione delle fatture elettroniche tramite SDI.",
                "category": "fiscale", "category_label": "Fiscale",
                "procedure_type": "official_procedure",
                "user_type": ["freelancer", "company"], "country_scope": "IT",
                "operational_status": "active_italy_scope",
                "scope_note": "Fatturazione elettronica tramite SDI.",
                "risk_level": "medium", "support_level": "supported",
                "expected_channel": "official_portal", "destination_type": "tax_authority",
                "required_documents": ["invoices"],
                "document_specs": [
                    {"key": "invoices", "name": "Dati fattura da emettere", "why_needed": "Per generare il file XML conforme allo standard SDI", "format": "Dati strutturati o bozza fattura", "mandatory": True},
                ],
                "official_action": {
                    "code": "emissione_fattura_elettronica",
                    "label": "Emissione fattura elettronica via SDI",
                    "description": "Generazione e invio della fattura elettronica tramite il Sistema di Interscambio",
                    "entity_name": "Agenzia delle Entrate (SDI)",
                    "form_reference": "Formato FatturaPA / FatturaB2B",
                },
                "who_acts": {"herion_prepares": True, "herion_submits": False, "user_submits": True, "user_signs": False, "delegation_possible": True, "entity_response_expected": True},
                "auth_method": "SPID",
                "proof_expected": {"type": "portal_confirmation", "timing": "delayed", "label": "Notifica di esito dal SDI (consegna/mancata consegna)", "optional": False},
                "estimated_duration": {"label": "1-3 giorni lavorativi", "min_days": 1, "max_days": 3},
                "delegation_required": False, "approval_required": False,
                "agents": ["research", "routing", "documents", "advisor"],
                "blocking_conditions": [],
                "escalation_conditions": ["fatturazione internazionale complessa"],
                "next_step": "Configurazione fatturazione elettronica",
                "user_explanation": "Ti supportiamo nella gestione della fatturazione elettronica tramite SDI.",
            },
            # ══════════════════════════════════════
            # CATEGORY: previdenziale (real official procedures)
            # ══════════════════════════════════════
            {
                "practice_id": "INPS_GESTIONE_SEP",
                "name": "Iscrizione Gestione Separata INPS",
                "description": "Supporto per l'iscrizione alla Gestione Separata INPS.",
                "category": "previdenziale", "category_label": "Previdenziale",
                "procedure_type": "official_procedure",
                "user_type": ["freelancer"], "country_scope": "IT",
                "operational_status": "active_italy_scope",
                "scope_note": "INPS — ente previdenziale.",
                "risk_level": "medium", "support_level": "supported",
                "expected_channel": "official_portal", "destination_type": "social_security",
                "required_documents": ["identity", "tax_declarations"],
                "document_specs": [
                    {"key": "identity", "name": "Documento di identita", "why_needed": "Per l'identificazione presso l'INPS", "format": "PDF o immagine", "mandatory": True},
                    {"key": "tax_declarations", "name": "Partita IVA attiva", "why_needed": "L'iscrizione alla Gestione Separata richiede P.IVA attiva", "format": "Visura camerale o certificato P.IVA", "mandatory": True},
                ],
                "official_action": {
                    "code": "iscrizione_gestione_separata",
                    "label": "Iscrizione Gestione Separata INPS",
                    "description": "Iscrizione alla Gestione Separata per liberi professionisti senza cassa previdenziale",
                    "entity_name": "INPS",
                    "form_reference": "Modulo iscrizione online INPS",
                },
                "who_acts": {"herion_prepares": True, "herion_submits": False, "user_submits": True, "user_signs": False, "delegation_possible": False, "entity_response_expected": True},
                "auth_method": "SPID",
                "proof_expected": {"type": "protocol_number", "timing": "immediate", "label": "Conferma iscrizione dall'area riservata INPS", "optional": False},
                "estimated_duration": {"label": "3-7 giorni lavorativi", "min_days": 3, "max_days": 7},
                "delegation_required": False, "approval_required": True,
                "agents": ["research", "routing", "documents", "flow"],
                "blocking_conditions": ["partita IVA non attiva"],
                "escalation_conditions": [],
                "next_step": "Preparazione iscrizione INPS",
                "user_explanation": "Ti guidiamo nell'iscrizione alla Gestione Separata INPS. Herion prepara i dati, tu completi l'iscrizione sul portale INPS.",
            },
            {
                "practice_id": "INPS_CASSETTO",
                "name": "Supporto cassetto previdenziale",
                "description": "Supporto per la consultazione del cassetto previdenziale INPS.",
                "category": "previdenziale", "category_label": "Previdenziale",
                "procedure_type": "official_procedure",
                "user_type": ["freelancer"], "country_scope": "IT",
                "operational_status": "active_italy_scope",
                "scope_note": "INPS — cassetto previdenziale.",
                "risk_level": "medium", "support_level": "supported",
                "expected_channel": "official_portal", "destination_type": "social_security",
                "required_documents": [],
                "document_specs": [],
                "official_action": {
                    "code": "consultazione_cassetto_previdenziale",
                    "label": "Consultazione cassetto previdenziale",
                    "description": "Accesso e consultazione del cassetto previdenziale sul portale INPS",
                    "entity_name": "INPS",
                    "form_reference": None,
                },
                "who_acts": {"herion_prepares": True, "herion_submits": False, "user_submits": False, "user_signs": False, "delegation_possible": False, "entity_response_expected": False},
                "auth_method": "SPID",
                "proof_expected": None,
                "estimated_duration": {"label": "Immediato (accesso online)", "min_days": 0, "max_days": 1},
                "delegation_required": False, "approval_required": False,
                "agents": ["research", "routing", "advisor", "monitor"],
                "blocking_conditions": [],
                "escalation_conditions": [],
                "next_step": "Accesso cassetto previdenziale",
                "user_explanation": "Ti aiutiamo a consultare e comprendere il tuo cassetto previdenziale INPS.",
            },
            # ══════════════════════════════════════
            # CATEGORY: societario (real official procedure)
            # ══════════════════════════════════════
            {
                "practice_id": "COMPANY_CLOSURE",
                "name": "Chiusura societaria post-liquidazione",
                "description": "Gestione completa del flusso di chiusura societaria dopo liquidazione.",
                "category": "societario", "category_label": "Societario",
                "procedure_type": "official_procedure",
                "user_type": ["company"], "country_scope": "IT",
                "operational_status": "active_italy_scope",
                "scope_note": "Camera di Commercio e Registro delle Imprese.",
                "risk_level": "medium", "support_level": "partially_supported",
                "expected_channel": "official_portal", "destination_type": "chamber_registry",
                "required_documents": ["company_documents", "accounting", "identity", "tax", "compliance"],
                "document_specs": [
                    {"key": "company_documents", "name": "Visura camerale e atto costitutivo", "why_needed": "Per verificare lo stato della societa e la legittimita della chiusura", "format": "PDF", "mandatory": True},
                    {"key": "accounting", "name": "Bilancio finale di liquidazione", "why_needed": "Obbligatorio per dimostrare l'avvenuta liquidazione", "format": "PDF firmato", "mandatory": True},
                    {"key": "identity", "name": "Documento del liquidatore", "why_needed": "Per identificare il soggetto responsabile della chiusura", "format": "PDF o immagine", "mandatory": True},
                    {"key": "tax", "name": "Certificazione debiti tributari", "why_needed": "Per confermare l'assenza di debiti verso l'erario", "format": "PDF", "mandatory": True},
                    {"key": "compliance", "name": "Dichiarazione di conformita", "why_needed": "Per attestare il rispetto degli obblighi di legge", "format": "PDF firmato", "mandatory": True},
                ],
                "optional_documents": ["delegation", "payment", "support_docs"],
                "conditional_documents": ["delegation"],
                "official_action": {
                    "code": "cancellazione_registro_imprese",
                    "label": "Cancellazione dal Registro delle Imprese",
                    "description": "Deposito della domanda di cancellazione presso la Camera di Commercio competente",
                    "entity_name": "Camera di Commercio",
                    "form_reference": "Modulo S3 / Pratica ComUnica",
                },
                "who_acts": {"herion_prepares": True, "herion_submits": False, "user_submits": True, "user_signs": True, "delegation_possible": True, "entity_response_expected": True},
                "auth_method": "SPID",
                "proof_expected": {"type": "protocol_number", "timing": "delayed", "label": "Numero protocollo del Registro delle Imprese", "optional": False},
                "estimated_duration": {"label": "10-30 giorni lavorativi", "min_days": 10, "max_days": 30},
                "delegation_required": True, "approval_required": True,
                "agents": ["intake", "research", "deadline", "flow", "routing", "delegate", "documents", "compliance", "ledger"],
                "blocking_conditions": ["liquidazione non completata", "documenti societari mancanti", "bilancio finale non approvato", "debiti tributari non risolti"],
                "escalation_conditions": ["contenziosi pendenti", "debiti non risolti", "irregolarita nella liquidazione"],
                "workflow_steps": ["Verifica requisiti chiusura", "Raccolta documenti societari", "Verifica bilancio finale", "Controllo conformita fiscale", "Preparazione delega", "Verifica delega", "Preparazione dossier chiusura", "Approvazione utente", "Invio al Registro delle Imprese"],
                "readiness_criteria": ["Bilancio finale approvato", "Tutti i debiti tributari risolti", "Documenti societari completi", "Delega valida", "Nessun contenzioso pendente"],
                "next_step": "Verifica requisiti chiusura",
                "user_explanation": "Herion prepara e gestisce il percorso di chiusura post-liquidazione. Verifichiamo requisiti, raccogliamo documenti, controlliamo la conformita fiscale e prepariamo il dossier. Tu firmi e invii al Registro delle Imprese.",
                "admin_notes": "Pratica semi-supportata: richiede preparazione completa ma invio tramite portale ufficiale.",
                "is_template": True,
            },
        ]
